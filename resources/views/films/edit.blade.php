                    ...
                    <form method="POST" action="{{ route('films.update', $film) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="observacoes" 
                                      ...
                                      placeholder="Suas impressões, comentários, etc...">{{ old('observacoes', $film->observacoes) }}</textarea>
                            @error('observacoes')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-3">
                                ...
                                <a href="{{ route('films.index') }}" 
                                   class="border border-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-50 transition duration-200">
                                    📋 Lista
                                </a>
                            </div>
                            <button type="submit" 
